...
async function main() {
  ...
  await Promise.all([
    db.card.update({ where: { slug: "amex-true-cashback" }, data: { rewardType: RewardType.CASHBACK, earnRate: 1.5, minimumSpend: 0, eligibleCategories: ["ALL"], channel: Channel.ANY, exclusions: ["Issuer exclusions apply"], status: PublishStatus.PUBLISHED, rewardRules: [{ label: "Ongoing eligible spend", rewardType: "CASHBACK", earnRate: 1.5, categories: ["ALL"], channel: "ANY", notes: ["The 3% new-cardmember offer is time-limited and is not used in this estimate."] }] } }),
    db.card.update({ where: { slug: "dbs-live-fresh" }, data: { rewardType: RewardType.CASHBACK, earnRate: 0.3, minimumSpend: 0, eligibleCategories: ["ALL"], channel: Channel.ANY, exclusions: ["Issuer exclusions apply"], status: PublishStatus.PUBLISHED, rewardRules: [{ label: "Shopping bonus cashback", rewardType: "CASHBACK", earnRate: 6, categories: ["SHOPPING"], channel: "ANY", minimumSpend: 800, monthlyCap: 50, capType: "REWARD", notes: ["Includes 0.3% base cashback and 5.7% additional cashback."] }, { label: "Transport bonus cashback", rewardType: "CASHBACK", earnRate: 6, categories: ["TRANSPORT"], channel: "ANY", minimumSpend: 800, monthlyCap: 20, capType: "REWARD", notes: ["Includes 0.3% base cashback and 5.7% additional cashback."] }, { label: "Base cashback", rewardType: "CASHBACK", earnRate: 0.3, categories: ["ALL"], channel: "ANY" }] } }),
    db.card.update({ where: { slug: "ocbc-365" }, data: { rewardType: RewardType.CASHBACK, earnRate: 0.25, minimumSpend: 0, eligibleCategories: ["ALL"], channel: Channel.ANY, exclusions: ["Issuer exclusions apply"], status: PublishStatus.PUBLISHED, rewardRules: [{ label: "Dining cashback", rewardType: "CASHBACK", earnRate: 5, categories: ["DINING"], channel: "ANY", minimumSpend: 800, monthlyCap: 160, capType: "REWARD", notes: ["Issuer uses S$800 and S$1,600 monthly spend tiers with total monthly cashback caps."] }, { label: "Base cashback", rewardType: "CASHBACK", earnRate: 0.25, categories: ["ALL"], channel: "ANY", maximumSpend: 799.99 }] } }),
    db.card.update({ where: { slug: "maybank-family-and-friends" }, data: { rewardType: RewardType.CASHBACK, earnRate: 0.22, minimumSpend: 0, eligibleCategories: ["ALL"], channel: Channel.ANY, exclusions: ["Issuer exclusions apply"], status: PublishStatus.PUBLISHED, rewardRules: [{ label: "Selected-category cashback (tier 2)", rewardType: "CASHBACK", earnRate: 8, categories: ["DINING", "GROCERIES", "TRANSPORT", "ONLINE", "SHOPPING"], channel: "ANY", minimumSpend: 1600, monthlyCap: 30, capType: "REWARD", requiresCardholderChoice: true, notes: ["Cap is per selected category."] }, { label: "Selected-category cashback (tier 1)", rewardType: "CASHBACK", earnRate: 6, categories: ["DINING", "GROCERIES", "TRANSPORT", "ONLINE", "SHOPPING"], channel: "ANY", minimumSpend: 800, maximumSpend: 1599.99, monthlyCap: 20, capType: "REWARD", requiresCardholderChoice: true, notes: ["Cap is per selected category."] }, { label: "Base cashback", rewardType: "CASHBACK", earnRate: 0.22, categories: ["ALL"], channel: "ANY" }] } }),
  ]);
